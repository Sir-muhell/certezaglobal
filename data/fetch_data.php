			...
			<div class="side_post">
				<a href="post.html">
					<div class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
						<div class="side_post_image"><div><a href="single.php?id='.$onedata['id'].'"><img src="blogadmin/images/'.$onedata['photo'].'" alt=""></a></div></div>
						<div class="side_post_content">
							<div class="side_post_title"><a href="single.php?id='.$onedata['id'].'" class="post-title">'.$onedata['title'].'</a></div>
							<small class="post_meta">Katy Liu<span>'.$onedata['date'].'</span></small>
						</div>
					</div>
				</a>
			</div>
