...
<html lang="en">
  <head>
    ...
    <title>Certeza Global | Admin Dashboard</title>
    <!-- plugins:css -->
              ...
              <div class="col-md-12">
                <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
                  <ul class="nav nav-tabs tab-transparent" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" data-toggle="tab" href="#latest" role="tab" aria-selected="false">Latest Article</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link"  data-toggle="tab" href="#most-viewed" role="tab" aria-selected="false">Most Viewed</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link"  data-toggle="tab" href="#comment" role="tab" aria-selected="false">Latest Comments</a>
                    </li>
                  </ul>
                ...
                <div class="tab-content tab-transparent-content">
                  <div class="tab-pane fade show active" id="most-viewed" role="tabpanel" >
                    <h4 class="card-title mb-0">Latest Activity</h4><br>
