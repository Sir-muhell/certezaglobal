<?php
	...
	if($_POST['action'] == 'saveProfile'){
		...
		sql("UPDATE `membership_users` set email='$email', custom1='$custom1', custom2='$custom2', custom3='$custom3', custom4='$custom4', custom5='$custom5', comments=CONCAT_WS('\\n', comments, 'member updated his profile on $updateDT from IP address {$mi[IP]}') WHERE memberID='{$mi['username']}'", $eo);
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<div class="form-group">
						<div class="form-control-static"><?php echo ucwords($mi['group']); ?></div>
					</div>
				</div>
			</div>
